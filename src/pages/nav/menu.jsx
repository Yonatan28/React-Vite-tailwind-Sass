...
<div class="relative bg-white">
  <div class="mx-auto max-w-7xl px-4 sm:px-6">
    <div class="flex item<div class="relative bg-white">
  <div class="mx-auto max-w-7xl px-4 sm:px-6">
            ...
            <div class="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
              <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                ...
                {/*   <!-- Heroicon name: outline/shield-check --> */}
                  <svg clas  <!-- Heroicon name: outline/arrow-path -->="h-6 w-6 flex-shrink-0 text-indigo-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
        ...
        <div class="mt-6">
          <nav class="grid gap-y-8">
           ...
           {/*    <!-- Heroicon name: outline/shield-check --> */}
            ...
            {/*   <!-- Heroicon name: outline/squares-2x2 --> */}
              <svg class="h-6 w-6 flex-shrink-0 text-indigo-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                <path stroke-linecap="rou  <!-- Heroicon name: outline/arrow-path -->
...
</div>s-center justify-between border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
      <div class="flex justify-start lg:w-0 lg:flex-1">
        <a href="#">
          <span class="sr-only">Your Company</span>
          <img class="h-8 w-auto sm:h-10" src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=600" alt="">
      ...
      <nav class="hidden space-x-10 md:flex">
       ...
       {/*    <!--
            ...
            Leaving: "transition ease-in duration-150"
              ...
              To: "opacity-0 translate-y-1"
          --> */}
          <div class="absolute z-10 -ml-4 mt  <!-- Heroicon name: outline/arrow-path -->-3 w-screen max-w-md transform px-2 sm:px-0 lg:left-1/2 lg:ml-0 lg:-translate-x-1/2">
            <div class="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
              <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                <a href="#" class="-m-3 flex items-start rounded-lg p-3 hover:bg-gray-50">
             {/*      <!-- Heroicon name: outline/chart-bar --> */}
      ...
      <div class="px-5 pt-5 pb-6">
        ...
        <div class="mt-6">
          <nav class="grid gap-y-8">
            ...
            <a href="#" class="-m-3 flex items-center rounded-md p-3 hover:bg-gray-50">
            <!-- Heroicon name: outline/arrow-path -->    </svg>
